...
/**
 * An entity that describes all the employees. It's the parent class of the
 * employees. Even if hourly and flat employees are different entities, they're
 * saved in the same table (see the "DiscriminatorColumn" annotation).
 * 
 * @author neeqstock
 *
 */
